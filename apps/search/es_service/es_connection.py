...
import sys
sys.path.append('./')
from apps.search.config.config_project import ES_IP, ES_USER, ES_PASS, ES_PORT

from apps.search.es_service.es_helper import check_status_es
from datetime import datetime
from apps.search.constants.law_constant import MAPPING
...
def example():
    ...
    check_status_es(es)
    print(es.get(index="law_tech", doc_type="_doc", id=1))
    #index = "law_tech"
